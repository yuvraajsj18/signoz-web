...
<Figure src="/img/guides/2024/07/golang-slog-golangslog-1.webp" alt="SigNoz localhost showcasing the log output of the above application." caption="SigNoz localhost showcasing the log output of the above application." />
